...
class About extends React.Component {
  ...
  render() {
    ...
    return (
      <div>
        <div id="About"className=" container-fluid col-md-12 h-aut w-100 p-5 bg-dark">
        ...
        <div className="card-container  col-md-12 my-5">
          <div className="row justify-content-center g-0">
            {Data_Display.map((val, index) => {
              return (
                <div
                  className="data-count card col-md-2 text-center "
                  key={index}
                >
              ...
              <div class="row">
                ...
                {this.state.selectedItem && (
                  ...
                  <div className="col-md-6">
                    <img src={this.state.selectedItem.img} className="img-fluid" style={{height:"300px"}}></img>
